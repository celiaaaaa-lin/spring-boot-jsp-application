...
public class TodoService {
    ...
    static {
        todos.add(new Todo(1, "Celia", "Learn Spring MVC", new Date(),
                false));
        todos.add(new Todo(2, "Celia", "Learn Struts", new Date(), false));
        todos.add(new Todo(3, "Celia", "Learn Hibernate", new Date(),
                false));
    }
